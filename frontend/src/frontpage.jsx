    ...
    return( 
        <div className="bg-purple-100 min-h-screen">
            <div className="overflow-x-hidden">
                <header className="relative w-full bg-black p-6 text-[#f9f9f9] m-0 overflow-x-hidden h-20 border-1 border-black">
                ...
                <section className="h-120 bg-[#D0F4DE] flex flex-col items-center justify-center text-center overflow-x-hidden border-1 border-black ">
                    <motion.div initial={{ opacity: 0, y: 20 }}        // start off invisible + moved down
                        ...
                        <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-7xl text-[#000814] font-bold overflow-y-hidden">Handcrafted crochet <br/> with love! <br/>Dorisa</h1>
                        <div className="my-5 h-7"></div>
                        <button onClick={() => navigate("/shop")}className="justify-center shadow-md hover:scale-105 text-black px-60 py-40 bg-[#FF99C8] rounded-lg hover:bg-slate-900 hover:text-white transition-duration-300 text-3xl hover:shadow-lg transition-transform border-2 border-black">shop now</button>
                    </motion.div>
                </section>
                ...
                <div className="h-10 bg-purple-200"></div>
                    <FadeInSection delay={0.4}>
                    <div className="h-100 bg-[#A9DEF9] text-black min-h-[13rem] flex flex-col items-center justify-center text-center overflow-x-hidden border-2 border-black">
                        <div className="text-6xl te font-bold">Dorisaa..</div>
                ...
                <div className="bg-purple-100 overflow-x-hidden">
                    <FadeInSection delay={0.4} className="bg-green-200">
                    <div className="bg-[#FCF6BD] overflow-x-hidden border-2 border-black">
                    <h1 className="text-black text-4xl mb-20 text-center">Categories</h1>
                    <div className="my-10 h-5"></div>
                        <div className=" bg-[#FCF6BD] flex justify-center gap-8 mt-10">
